 ...
 */
function tym_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['tym_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('tym sample setting'),
  '#default_value' => theme_get_setting('tym_example'),
