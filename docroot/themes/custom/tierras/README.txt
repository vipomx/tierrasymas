...
http://foundation.zurb.com/docs/faq.php or use the script in the tierras
...
* if you have Drush installed.
 ...
 1. Setup the location for your new sub-theme.
    ...
    Copy the tierras folder out of the zurb_foundation/ folder and rename it to
    ...
    For example, copy the themes/zurb_foundation/tierras folder and
 ...
 2. Setup the basic information for your sub-theme.
    ...
    In your new sub-theme folder, rename the tierras.info.yml.txt file to include
    the name of your new sub-theme and remove the ".txt" extension. Then edit
    the .info file by editing the name and description field.

    For example, rename the foo/tierras.info.yml.txt file to foo/foo.info.yml. Edit the
    foo.info.yml file and change "name: Foundation Sub-theme tierras" to
...
Optional steps:
 ...
 8. Add custom css and js files to your sub-theme
    ...
    Rename tierras.libraries.yml to the name of your sub-theme, un-commenting
